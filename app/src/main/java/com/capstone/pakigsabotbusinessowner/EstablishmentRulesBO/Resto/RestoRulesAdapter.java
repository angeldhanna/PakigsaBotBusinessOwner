package com.capstone.pakigsabotbusinessowner.EstablishmentRulesBO.Resto;
...
public class RestoRulesAdapter extends RecyclerView.Adapter<RestoRulesAdapter.MyViewHolder>{
    ...
    public RestoRulesAdapter() {
    }

    public RestoRulesAdapter(Context context, ArrayList<RestoRulesModel> restoERArrayList) {
    ...
    @NonNull
    @Override
    public RestoRulesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RestoRulesAdapter.MyViewHolder holder, int position) {
        // setting data to our text views from our modal class.
        RestoRulesModel list = restoERArrayList.get(position);
        holder.desc.setText(list.getRestoRuleDesc());
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Retrieving Data
                descTxt.setText(list.getRestoRuleDesc());
                ...
                updateBtnPopUp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (descTxtStr.isEmpty()) {
                            ...
                            rules.put("resto_ruleId", list.getRestoRuleId());
                            rules.put("resto_desc", descTxtStr);
                            rules.put("estId", list.getEstId());


                            String userID = fAuth.getCurrentUser().getUid();
                            fStore.collection("establishments").document(userID).collection("resto-est-rules").document(list.getRestoRuleId()).set(rules)
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String userID = fAuth.getCurrentUser().getUid();
                                fStore.collection("establishments").document(userID).collection("resto-est-rules").document(list.getRestoRuleId())
                                        .delete()
