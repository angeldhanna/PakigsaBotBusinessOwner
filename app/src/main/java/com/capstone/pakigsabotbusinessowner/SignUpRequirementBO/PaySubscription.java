package com.capstone.pakigsabotbusinessowner.SignUpRequirementBO;
...
import com.capstone.pakigsabotbusinessowner.SignUpBO;
...
public class PaySubscription extends AppCompatActivity {
    ...
    private void signUp(){
        Intent intent = new Intent(getApplicationContext(), SignUpBO.class);
        startActivity(intent);
    }

    //Go back to Main Page::
    private void mainScreen(){
        startActivity(new Intent(getApplicationContext(), MainActivityBO.class));
    }
