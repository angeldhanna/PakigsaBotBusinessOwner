package com.capstone.pakigsabotbusinessowner.ReservationsBO;
...
import com.capstone.pakigsabotbusinessowner.NavigationFragmentsBO.HelpCenterFragment;
...
import com.capstone.pakigsabotbusinessowner.ReservationsBO.Adapter.RestoReservationsAdapter;
...
public class ViewReservationsResto extends AppCompatActivity {
    ...
    RestoReservationsAdapter reservationsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservations_resto);
        //References
        refs();
        ...
        reservationsAdapter = new RestoReservationsAdapter(ViewReservationsResto.this, reservationsArrayList);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationsResto.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getReservationsDates() {
        ...
        fStore.collection("reservations")
                .orderBy("reserv_dateIn", Query.Direction.ASCENDING)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
