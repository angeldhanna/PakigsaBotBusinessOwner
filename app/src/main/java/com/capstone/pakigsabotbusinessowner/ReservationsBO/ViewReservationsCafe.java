...
public class ViewReservationsCafe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reservationsAdapter = new RestoReservationsAdapter(ViewReservationsCafe.this, reservationsArrayList);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationsCafe.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void filter(String newText){
        ...
        for(ReservationsModel item : reservationsArrayList){
            if(item.getReserveDateIn().startsWith(newText.toLowerCase())){
