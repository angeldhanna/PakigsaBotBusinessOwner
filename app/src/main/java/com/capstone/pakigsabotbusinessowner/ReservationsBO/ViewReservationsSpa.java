...
import com.capstone.pakigsabotbusinessowner.ReservationsBO.Adapter.ReservationsAdapter;
...
public class ViewReservationsSpa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservations_spa);
        //References
        refs();
        ...
        reservationsAdapter = new ReservationsAdapter(ViewReservationsSpa.this, reservationsArrayList);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationsSpa.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
