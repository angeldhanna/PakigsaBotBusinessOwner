package com.capstone.pakigsabotbusinessowner.ResortBO.Adapters;
...
import com.capstone.pakigsabotbusinessowner.ResortBO.Models.ResortFacilityModel;
...
public class ResortFacilityAdapter extends RecyclerView.Adapter<ResortFacilityAdapter.MyViewHolder>{
    ...
    public ResortFacilityAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context).inflate(R.layout.resort_facility_item_bo,parent,false);
