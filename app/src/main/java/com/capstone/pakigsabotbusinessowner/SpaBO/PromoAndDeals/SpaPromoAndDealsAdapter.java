package com.capstone.pakigsabotbusinessowner.SpaBO.PromoAndDeals;
...
public class SpaPromoAndDealsAdapter extends RecyclerView.Adapter<SpaPromoAndDealsAdapter.MyViewHolder>{
    ...
    public SpaPromoAndDealsAdapter() {
        //empty constructor needed
    }

    //creating constructor for the adapter class
    public SpaPromoAndDealsAdapter(Context context, ArrayList<SpaPromoAndDealsModel> spaPADArrayList) {
        this.context = context;
        this.spaPADArrayList = spaPADArrayList;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        SpaPromoAndDealsModel spaPADList = spaPADArrayList.get(position);

        holder.name.setText(spaPADList.getSpaPADName());
        holder.desc.setText(spaPADList.getSpaPADDesc());
        holder.startDate.setText(spaPADList.getSpaPADStartDate());
        holder.endDate.setText(spaPADList.getSpaPADEndDate());
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Retrieving Data
                nameTxt.setText(spaPADList.getSpaPADName());
                descTxt.setText(spaPADList.getSpaPADDesc());
                startDateTxt.setText(spaPADList.getSpaPADStartDate());
                endDateTxt.setText(spaPADList.getSpaPADEndDate());
                ...
                updateBtnPopUp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(txtPADName.isEmpty() || txtPADDesc.isEmpty() || txtPADStartDate.isEmpty() || txtPADEndDate.isEmpty()){
                            ...
                            spaPAD.put("spaPADId", spaPADList.getSpaPADId());


                            String userId = fAuth.getCurrentUser().getUid();
                            fStore.collection("establishments").document(userId).collection("spa-promos-and-deals").document(spaPADList.getSpaPADId()).set(spaPAD)
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(context)
                        ...
                        .setMessage("Do you want to Delete " + spaPADList.getSpaPADName()+ "?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String userId = fAuth.getCurrentUser().getUid();
                                fStore.collection("establishments").document(userId).collection("spa-promo-and-deals").document(spaPADList.getSpaPADId())
                                        .delete()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                progressDialog.dismiss();
                                                Toast.makeText(context, spaPADList.getSpaPADName() + " Successfully Deleted", Toast.LENGTH_SHORT).show();
                                                spaPADArrayList.remove(position);
