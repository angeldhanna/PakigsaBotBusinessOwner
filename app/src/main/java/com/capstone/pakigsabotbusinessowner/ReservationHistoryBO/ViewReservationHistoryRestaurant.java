package com.capstone.pakigsabotbusinessowner.ReservationHistoryBO;
...
import com.capstone.pakigsabotbusinessowner.FeedbackBO.LoadFeedback;
import com.capstone.pakigsabotbusinessowner.NavigationFragmentsBO.HistoryFragment;
import com.capstone.pakigsabotbusinessowner.R;
import com.capstone.pakigsabotbusinessowner.ReservationHistoryBO.Adapter.CancelledRHistoryAdapter;
import com.capstone.pakigsabotbusinessowner.ReservationHistoryBO.Adapter.CompletedRHistoryAdapter;
import com.capstone.pakigsabotbusinessowner.ReservationHistoryBO.Model.CancelledRHistoryModel;
import com.capstone.pakigsabotbusinessowner.ReservationHistoryBO.Model.CompletedRHistoryModel;
...
public class ViewReservationHistoryRestaurant extends AppCompatActivity {
    //Initialization of Variables::
    ImageView imgBackBtn, feedbackBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservation_history_restaurant);
        //References::
        refs();

        //--FOR COMPLETED RESERVATIONS--
        //recyclerview initialization
        completedReservationsRecyclerView = findViewById(R.id.rHistoryRecyclerViewCompleteResto);
        ...
        completedRHistoryAdapter = new CompletedRHistoryAdapter(ViewReservationHistoryRestaurant.this, completedRHistoryArrayList);
        ...
        //recyclerview initialization
        cancelledReservationRecyclerView = findViewById(R.id.rHistoryRecyclerViewCancelledResto);
        ...
        //initializing the adapter
        cancelledRHistoryAdapter = new CancelledRHistoryAdapter(ViewReservationHistoryRestaurant.this, cancelledRHistoryArrayList);
        ...
        feedbackBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LoadFeedback.class);
                startActivity(intent);
            }
        });
    ...
    private void refs() {
        completedReservationsSwipeRefresh = findViewById(R.id.rHistorySwipeRefreshCompleteResto);
        cancelledReservationsSwipeRefresh = findViewById(R.id.rHistorySwipeRefresCancelledResto);
        imgBackBtn = findViewById(R.id.backBtnRHistoryResto);
        feedbackBtn = findViewById(R.id.estFeedbackResto);
    }
    ...
    public void getCompletedReservationsList() {
        ...
        fStore.collection("completed-reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationHistoryRestaurant.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
