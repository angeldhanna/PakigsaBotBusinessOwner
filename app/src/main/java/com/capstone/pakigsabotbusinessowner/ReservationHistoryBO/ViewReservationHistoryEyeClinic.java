...
public class ViewReservationHistoryEyeClinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservation_history_eye_clinic);
        ...
        completedRHistoryAdapter = new CompletedRHistoryAdapter(ViewReservationHistoryEyeClinic.this, completedRHistoryArrayList);
        ...
        //initializing the adapter
        cancelledRHistoryAdapter = new CancelledRHistoryAdapter(ViewReservationHistoryEyeClinic.this, cancelledRHistoryArrayList);
    ...
    public void getCompletedReservationsList() {
        ...
        fStore.collection("completed-reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationHistoryEyeClinic.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
