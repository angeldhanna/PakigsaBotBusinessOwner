...
public class ViewReservationHistoryResort extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservation_history_resort);
        ...
        completedRHistoryAdapter = new CompletedRHistoryAdapter(ViewReservationHistoryResort.this, completedRHistoryArrayList);
        ...
        //initializing the adapter
        cancelledRHistoryAdapter = new CancelledRHistoryAdapter(ViewReservationHistoryResort.this, cancelledRHistoryArrayList);
    ...
    public void getCompletedReservationsList() {
        ...
        fStore.collection("completed-reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationHistoryResort.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
